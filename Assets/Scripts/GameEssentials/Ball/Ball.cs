...
namespace GameEssentials.Ball
{
    public class Ball : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            Physics2D.IgnoreLayerCollision(LayerMask.NameToLayer("NoCollisionBallLayer"),
                LayerMask.NameToLayer("NoCollisionBallLayer"), true);
        }
        ...
        private void Update()
        {
            ...
            RaycastHit2D hitRight =
                Physics2D.Raycast(new Vector2(pos.x + ccRadius + 0.01f, pos.y), Vector2.right, ccRadius / 2);
            RaycastHit2D hitLeft =
                Physics2D.Raycast(new Vector2(pos.x - ccRadius - 0.01f, pos.y), Vector2.left, ccRadius / 2);
